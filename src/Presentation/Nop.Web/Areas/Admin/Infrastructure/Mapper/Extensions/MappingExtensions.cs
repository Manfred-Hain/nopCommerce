...
namespace Nop.Web.Areas.Admin.Infrastructure.Mapper.Extensions
{
    ...
    public static class MappingExtensions
    {
        ...
        /// <param name="source">Source object to map from</param>
        /// <returns>Mapped destination object</returns>
        private static TDestination Map<TSource, TDestination>(this TSource source)
        {
            //use AutoMapper for mapping objects
        ...
        /// <returns>Mapped destination object</returns>
        private static object Map(this object source, Type sourceType, Type destinationType)
        {
            //use AutoMapper for mapping objects
            return AutoMapperConfiguration.Mapper.Map(source, sourceType, destinationType);
        }
        ...
        /// <summary>
        /// Execute a mapping from the source object to the existing destination object with explicit types
        /// </summary>
        /// <param name="source">Source object to map from</param>
        /// <param name="destination">Destination object to map into</param>
        /// <param name="sourceType">Source object type</param>
        /// <param name="destinationType">Destination object type</param>
        /// <returns></returns>
        private static object MapTo(this object source, object destination, Type sourceType, Type destinationType)
        {
            //use AutoMapper for mapping objects
            return AutoMapperConfiguration.Mapper.Map(source, destination, sourceType, destinationType);
        }
